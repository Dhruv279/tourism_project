                        ...
                        <div class="py-8 sm:py-20 pl-8 sm:pl-21 pr-8 sm:pr-20">
                            <form>
                                ...
                                <div class="flex items-center justify-between mb-7.5">
                                        ...
                                        <label for="checkboxLabelTwo"
                                            ...
                                            <div class="relative">
                                                ...
                                                <div :class="checkboxToggle && 'border-purple bg-purple'"
                                                    ...
                                                    <span :class="checkboxToggle && '!opacity-100'"
                                                        class="opacity-0">
                                    ...
                                    <a href="index.php#" class="font-medium text-sm text-purple">Forgot
                                        Password?</a>
                                </div>
                                <button type="submit"
                                ...
                                <p class="text-center font-medium text-white mt-5">
                                    ...
                                    <a href="signup.php" class="text-purple">Sign Up for Free</a>
                                </p>
                            </form>
                        </div>
                    </div>
